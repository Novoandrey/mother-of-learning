...
Слоты 020–028 заняты: **020** PC Holdings (spec+plan готовы), **021** Wiki editor
(дизайн-пак, папка не создана), **022** Player Mobile (Specify→Clarify), **023–027**
инфра-эпик ✅, **028** Auto-deploy (stub). **029** — буфер. Дальнейшие фичи (черновой
...
доступ Claude к БД для анализа (запись — через UI/выверенный SQL). Мини-спека.
