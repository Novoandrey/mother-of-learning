...
1. **Эпик «RPG-движок» (chat 93, 95)** — канон эпика:
   ...
   с телефона (FR-023), одна-правда-всегда-свежая (FR-024);
   **прозрачность R6**: все читают все листы и модули, правка по правам.
   Coverage-checklist заведён: Миряна — можно сейчас, Каэл — ждёт
   LSS-экспорт, Британия — источник листа не зафиксирован. spec-022 ждёт
   044; design.md — UX-вход, ~80% переживает.
