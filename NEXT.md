...
инфра-эпик ✅, **028** Infra access (Лёша/Никита — spec готов, chat 88), **029**
Read-only Postgres MCP для Claude (spec готов, chat 88). Auto-deploy-стаб переехал
**028 → 043** (освободил 028 под доступ). Дальнейшие фичи (черновой порядок по
...
| 043 | Auto-deploy / CI-on-push (бывш. 028, stub) | после 027; Vercel-CI-парити |
