...
> Last updated: 2026-06-12 (chat 95 — конституция v1.3.0, ресерч, spec-044 v2 и spec-051 Mobile Ledger на ревью; chat 94 — spec-043 Done: staging live)
...
1. **Эпик «RPG-движок» (chat 93, 95)** — канон эпика:
   ...
   **прозрачность R6**: все читают все листы и модули, правка по правам.
   ...
   spec-022 ждёт 044; design.md — UX-вход, ~80% переживает. Решения
   chat 95 поздно вечером: **R9** (неопознанные предметы — флаг
   `identified`, маскировка имени) и **R10 + spec-051 Mobile Ledger**
   (Specify draft — на ревью): параллельный трек поверх готовой
   бухгалтерии 009–019, кандидат на ПЕРВЫЙ PWA-шип, несёт PWA-шелл и
   реалтайм (DEBT-011). Решения D-1А…D-6А применены (R11), мана-система — R12/FR-025; ждёт данных: таблица уровень→мана (xlsx/Сергей).
...
| 051 | Mobile Ledger — кошелёк/бухгалтерия игрока (PWA-шелл-pathfinder) | — параллельно; кандидат на первый шип |
