...
> Last updated: 2026-06-07 (chat 87 — **spec-027 cutover & decommission ЗАКРЫТ;
...
инфра-эпик ✅, **028** Server ops — доступ команде (Лёша/Никита/Сергей) **+
auto-deploy**, два user stories, **Specify→Clarify** (chat 88; auto-deploy свёрнут
сюда из бывш. стаба 043), **029** Read-only Postgres MCP для Claude (мини-спека
готова, chat 88). Дальнейшие фичи (черновой порядок по зависимостям, финализируется
при взятии в работу):
