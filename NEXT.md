...
> Last updated: 2026-06-10 (chat 93 — design.md v1 для 022 на ревью; следующий шаг: ревью → Plan)
...
1. **spec-022 Player Mobile Mode (PWA)** — **Clarified (chat 92); design.md v1
   на ревью (chat 93)**. Скоуп v2: живой чарлист по системе Стасяна + кубы +
   импорт xlsx; деньги/предметы → P2; компендиум и билдер — фазы 2–3 эпика.
   Reference-артефакты — в `references/` спеки. UX/UI дизайн-документ
   `design.md` (15 решений D-01..D-15, два затрагивают спеку: D-07 prepared,
   D-08 состояния). Следующий шаг — **ревью Андрея → design v1.1 → Plan**.
