...
> Last updated: 2026-06-10 (chat 93 — reference-артефакты импорта в спеке 022; следующий шаг: Plan)
...
1. **spec-022 Player Mobile Mode (PWA)** — **Clarified (chat 92) — awaiting
   Plan**. Скоуп v2: живой чарлист по системе Стасяна + кубы + импорт xlsx;
   деньги/предметы → P2; компендиум и билдер — фазы 2–3 эпика, отдельные
   спеки. Reference-артефакты (таблица Стасяна — 4 эталонных листа; образец
   LSS-экспорта) — в `references/` спеки (chat 93). Следующий шаг — **Plan**.
