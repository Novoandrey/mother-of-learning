...
> Last updated: 2026-04-19 (chat 21 — spec-006 инкремент 1: auth фундамент)
...
11. ~~Spec-006 инкремент 1: auth фундамент~~ ✅ (код, ждёт деплой)
12. **→ Spec-006 инкремент 2: приглашение ДМов (/members для owner)**
