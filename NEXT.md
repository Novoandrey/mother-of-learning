...
1. **Эпик «RPG-движок» (chat 93, 95)** — канон эпика:
   ...
   R1–R8; создана по ревью Андрея). Карта (v1.6.0): телега(046) ∥ ledger(044) → движок → лист → базы → форк →
   ...
   **прозрачность R6**: все читают все листы и модули, правка по правам.
   ...
   constitution v1.6.0 (контентный хвост +1: спеллы 047 … хоумбрю 052). Решения D-1А…D-6А применены (R11), мана-система — R12/FR-025; мана-таблица = DMG Spell Points (подтверждено).
