...
import { formatGp, formatSignedGp, dayLabel } from './format'
import {
  Centered,
  Portrait,
  Avatar,
...
// ─────────────────────────── shared ───────────────────────────
// UI-примитивы (Sheet, поля, кошелёк, лента, аватары…) вынесены в
// ./primitives.tsx (spec-058 W1) — новый shell и модули табов берут их оттуда.
// Centered ре-экспортируется для старых импортёров этого файла.
