...
--   Локи Лафейсон                         → Локи
--   Аврора Монро                          → Аврора
--   Маркус «Хоппер» Грейсон               → Маркус Грэйсон   (Стасян's canonical spelling — sheet's «Грейсон» is the sheet's typo, normalized to «Грэйсон» in fields)
...
with desired (db_title, patch) as (values
  ...
  ('Маркус Грэйсон', '{"description": "Звезда сборной Академии по борьбе, спортивная гордость учебного заведения и душа вечеринок. Харизматичный тусовщик, «пьяный мастер», автор песни «шняга шняжная».", "class": "Монах альтернативный", "height_cm": 192, "familiar": "Красавчик — фамильяр пëс", "player_full_name": "Стасян", "alt_name": "Маркус «Хоппер» Грэйсон", "art_name": "Маркус Хоппер", "ai_art_name": "Маркус Грэйсон"}'::jsonb),
