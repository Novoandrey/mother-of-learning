...
-- (Щит 1/день)=100 · кольцо хранения (миззиев аппарат)=500 · плащ защиты +1 (Щит)=150.
--
...
seed(schema_title, target_title, schema_rarity, price_gp, craft_cost_gp) as (values
  ...
  ('Схема: Плащ защиты +1 (вплетено: Щит)', 'Плащ защиты', null, null, 150)  -- «Щит +1» из списка = плащ защиты+1 с Щит: 75 база + 75 вплетение (ур.1)
),
ins as (
