...
Машинерия паков строится в **эпике «RPG-движок»** — спеки 045–052
...
| База спеллов (машинерия баз dnd.su) | спека 047 |
| Форк нод (`forked_from`, хоумбрю) | спека 048 |
| База фитов + бэкграундов | спека 049 |
| Пирамида прогрессии (level-up) | спека 050 |
| База классов / мана-максимум (DMG Spell Points) | спека 051 |
| Конструктор хоумбрю (effect-блоки) | спека 052 |
