...
> будущего `runbook.md`. Версии сверены 2026-06-03.
...
> **db-образ обязательно override-им на `supabase/postgres:17.x`** (цель —
> `17.6.1.104` или ближайший публичный `17.6.1.x` на hub.docker.com; ≥ прод
> по патчу). Это отклонение от «протестировано вместе», но практический
