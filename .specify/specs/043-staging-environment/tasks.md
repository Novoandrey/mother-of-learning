...
- (tail) **T017** 🧑 SC-003: Лёша или Никита прогоняет полный цикл (ветка →
      staging → PR в main) только по докам, без Андрея.
- [x] **T018** 🧑 FR-011 доставка ✅ (2026-06-12): инструкции переклеены в
      Claude-проект Андрея; универсальный файл отправлен Никите и Лёше.
