...
- [x] **T001** [P1] Write `mat-ucheniya/supabase/migrations/035_stash_and_item_qty.sql`:
...
- [x] **T003** [P] [P1] Create `mat-ucheniya/lib/stash-aggregation.ts`:
...
- [x] **T004** [P] [P1] Extend `mat-ucheniya/lib/transaction-resolver.ts`:
...
- [x] **T005** [P] [P1] Extend `mat-ucheniya/lib/transaction-validation.ts`:
...
- [x] **T006** [P] [P1] Create `mat-ucheniya/lib/__tests__/stash-aggregation.test.ts` — 7 cases from plan `## Testing`:
...
- [x] **T007** [P] [P1] Create `mat-ucheniya/lib/__tests__/shortfall-resolver.test.ts` — 5 cases from plan `## Testing`:
...
- [x] **T008** [P1] Create `mat-ucheniya/lib/stash.ts` — types section:
...
- [x] **T009** [P1] Extend `mat-ucheniya/lib/transactions.ts`:
...
- [x] **T010** [P1] Extend `mat-ucheniya/lib/stash.ts` — `getStashNode(campaignId)`:
...
- [x] **T011** [P1] Extend `mat-ucheniya/lib/stash.ts` — `getStashContents(campaignId, loopNumber)`:
...
- [x] **T012** [P1] Create `mat-ucheniya/lib/seeds/stash.ts`:
...
- [x] **T013** [P1] Modify `mat-ucheniya/lib/campaign-actions.ts`:
...
- [x] **T014** [P1] Extend `mat-ucheniya/app/actions/transactions.ts` — `createItemTransfer`:
...
- [x] **T015** [P1] Extend `mat-ucheniya/app/actions/transactions.ts` — `itemQty` on create/update/delete:
...
- [x] **T016** [P1] Create `mat-ucheniya/app/actions/stash.ts` — money wrappers:
  - `'use server'` header
...
- [x] **T017** [P1] Extend `mat-ucheniya/app/actions/stash.ts` — item wrappers:
...
- [x] **T018** [P1] Extend `mat-ucheniya/app/actions/stash.ts` — `getStashAggregate`:
...
- [x] **T019** [P1] Extend `mat-ucheniya/app/actions/stash.ts` — `createExpenseWithStashShortfall`:
...
- [x] **T020** [P] [P1] Create `mat-ucheniya/components/inventory-grid.tsx` (server):
...
- [x] **T021** [P] [P1] Create `mat-ucheniya/components/inventory-grid-row.tsx` (client):
...
- [x] **T022** [P] [P1] Create `mat-ucheniya/components/stash-buttons.tsx` (client):
...
- [x] **T023** [P] [P1] Create `mat-ucheniya/components/shortfall-prompt.tsx` (client):
...
- [x] **T024** [P1] Modify `mat-ucheniya/components/transaction-form.tsx` — qty input for `kind='item'`:
...
- [x] **T025** [P1] Modify `mat-ucheniya/components/transaction-form.tsx` — stash-pinned mode:
...
- [x] **T026** [P1] Modify `mat-ucheniya/components/transaction-form.tsx` — shortfall prompt integration:
...
- [x] **T027** [P1] Modify `mat-ucheniya/components/transaction-form-sheet.tsx`:
...
- [x] **T028** [P] [P1] Modify `mat-ucheniya/components/wallet-block.tsx`:
...
- [x] **T029** [P] [P1] Modify `mat-ucheniya/components/wallet-block-client.tsx`:
...
- [x] **T030** [P1] Modify `mat-ucheniya/components/ledger-actor-bar.tsx`:
...
- [x] **T031** [P1] Create `mat-ucheniya/app/c/[slug]/accounting/stash/page.tsx`:
...
- [x] **T032** [P1] Modify `mat-ucheniya/app/c/[slug]/catalog/[id]/page.tsx`:
...
- [x] **T033** [P1] Run `npm run lint`, `npm run typecheck`, `npm run test` in `mat-ucheniya/`. Fix anything that falls out.
...
- [x] **T036** [P1] Commit + push. Commit message: `feat(stash): ship spec-011 common stash (migrations 035)`.
