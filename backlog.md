...
> **Статус** (chat 88): (б) бэкапы — закрыто spec-025 (R2 + drill); (а) доступы —
> теперь **spec-028 US1** (full-ops для Лёши/Никиты/Сергея), US2 в проде, US1 ждёт
> SSH-ключей. Эта IDEA по сути реализована спеками 025+028.
