...
### ~~IDEA-010~~ ✅ IN PROGRESS → Spec-005 Энкаунтер-трекер: Excel-first редизайн
- Реализовано: spec-005-encounter-tracker-v2. Новый grid, delta HP, TagCell.
- 25/30 задач выполнено. На тестировании.
...
### IDEA-015 Модель "Игрок заявляет → ДМ подтверждает"
